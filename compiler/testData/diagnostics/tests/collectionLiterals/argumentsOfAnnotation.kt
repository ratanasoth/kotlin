...
@Foo([<!NI;CONSTANT_EXPECTED_TYPE_MISMATCH!><!NI;CONSTANT_EXPECTED_TYPE_MISMATCH!><!CONSTANT_EXPECTED_TYPE_MISMATCH!>1f<!><!><!>], <!TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH!>[<!NI;CONSTANT_EXPECTED_TYPE_MISMATCH!>' '<!>]<!>, [<!NI;CONSTANT_EXPECTED_TYPE_MISMATCH!><!NI;CONSTANT_EXPECTED_TYPE_MISMATCH!><!CONSTANT_EXPECTED_TYPE_MISMATCH!>1<!><!><!>])
fun test3() {}
