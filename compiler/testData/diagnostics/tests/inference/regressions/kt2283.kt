...
fun foo() {
    ...
    val <!NI;UNUSED_VARIABLE!><!UNUSED_VARIABLE!>m<!><!>: Foo<String> = l.<!TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH!>map { <!NI;UNUSED_ANONYMOUS_PARAMETER!><!UNUSED_ANONYMOUS_PARAMETER!>ppp<!><!> -> 1 }<!>
}
