...
fun main(args : Array<String>) {
    ...
    join(x = <!NON_VARARG_SPREAD!>*<!>1, a = *<!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!><!TYPE_MISMATCH!>"2"<!><!><!>)
    join(x = 1, a = *a)
    ...
    joinG<String>(x = <!NON_VARARG_SPREAD!>*<!>1, a = *<!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!><!TYPE_MISMATCH!>"2"<!><!><!>)
    joinG<String>(1, *a)
    joinG<String>(1, *a, "3")
    ...
    <!TYPE_INFERENCE_PARAMETER_CONSTRAINT_ERROR!>joinG<!>(x = <!NON_VARARG_SPREAD!>*<!>1, a = *<!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!><!TYPE_MISMATCH!>"2"<!><!><!>)
    joinG(1, *a)
    joinG(1, *a, "3")
    joinG(1, "4", *a, "3")
    joinG(1, "4", *a)
