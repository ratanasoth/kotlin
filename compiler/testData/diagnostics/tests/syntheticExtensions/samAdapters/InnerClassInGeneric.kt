...
fun foo(javaClass: JavaClass<Int>): Int {
    ...
    return <!NI;TYPE_MISMATCH!><!TYPE_MISMATCH!>inner.doSomething(<!NI;CONSTANT_EXPECTED_TYPE_MISMATCH!><!CONSTANT_EXPECTED_TYPE_MISMATCH!>1<!><!>, "") <!NI;TYPE_MISMATCH!><!TYPE_MISMATCH!>{ }<!><!><!><!>
}
