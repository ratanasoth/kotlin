...
fun text() {
    ...
    bar <!NI;TYPE_MISMATCH!><!NI;EXPECTED_PARAMETERS_NUMBER_MISMATCH!><!EXPECTED_PARAMETERS_NUMBER_MISMATCH!>{<!><!><!NI;TYPE_MISMATCH!><!NI;UNRESOLVED_REFERENCE!><!UNRESOLVED_REFERENCE!>it<!><!> <!NI;DEBUG_INFO_ELEMENT_WITH_ERROR_TYPE!><!DEBUG_INFO_ELEMENT_WITH_ERROR_TYPE!>+<!><!> 1<!>}<!>
    ...
    bar2 <!NI;TYPE_MISMATCH!>{<!EXPECTED_PARAMETERS_NUMBER_MISMATCH!><!CANNOT_INFER_PARAMETER_TYPE!>it<!><!> -> <!NI;TYPE_MISMATCH!><!DEBUG_INFO_ELEMENT_WITH_ERROR_TYPE!>it<!><!>}<!>
}
