...
fun text() {
    ...
    bar2 <!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>{<!EXPECTED_PARAMETERS_NUMBER_MISMATCH!><!CANNOT_INFER_PARAMETER_TYPE!>it<!><!> -> <!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!><!DEBUG_INFO_ELEMENT_WITH_ERROR_TYPE!>it<!><!><!>}<!><!>
}
