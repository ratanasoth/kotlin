...
fun main() {
    ...
    checkSubtype<Outer<CharSequence>.Inner>(<!NI;TYPE_MISMATCH!><!TYPE_MISMATCH!>outer.bar()<!><!>)
    checkSubtype<Outer<CharSequence>.Inner>(<!NI;TYPE_MISMATCH!><!TYPE_MISMATCH!>outer.Inner()<!><!>)
