...
class Derived : Base() {
    ...
    fun foo() {
        ...
        super.bar(<!NI;TYPE_MISMATCH!><!TYPE_MISMATCH!>x<!><!>)
        this.baz(<!NI;TYPE_MISMATCH!><!TYPE_MISMATCH!>x<!><!>)
        if (x == null) return
        ...
        else this.baz(super.bar(<!NI;TYPE_MISMATCH!><!NI;DEBUG_INFO_CONSTANT!><!TYPE_MISMATCH!><!DEBUG_INFO_CONSTANT!>y<!><!><!><!>))
    }
}
