...
fun f2(s: Int?): Int {
    return when (s) {
        !is Int -> <!NI;TYPE_MISMATCH!><!TYPE_MISMATCH!>s<!><!>
        else -> <!NI;DEBUG_INFO_SMARTCAST!><!DEBUG_INFO_SMARTCAST!>s<!><!>
    }
}
...
fun f3(s: Int?): Int {
    return when (s) {
        ...
        else -> <!NI;TYPE_MISMATCH!><!TYPE_MISMATCH!>s<!><!>
    }
}
...
fun f4(s: Int?): Int {
    return when {
        ...
        s == null -> <!NI;TYPE_MISMATCH!><!NI;DEBUG_INFO_CONSTANT!><!TYPE_MISMATCH!><!DEBUG_INFO_CONSTANT!>s<!><!><!><!>
        else -> <!NI;DEBUG_INFO_SMARTCAST!><!DEBUG_INFO_SMARTCAST!>s<!><!>
    }
}
...
fun f5(s: Int?): Int {
    return when (s) {
        s -> <!NI;TYPE_MISMATCH!><!TYPE_MISMATCH!>s<!><!>
...
fun f7(s: Int?): Int {
    return when {
        s !is Int -> <!NI;TYPE_MISMATCH!><!TYPE_MISMATCH!>s<!><!>
        else -> <!NI;DEBUG_INFO_SMARTCAST!><!DEBUG_INFO_SMARTCAST!>s<!><!>
    }
}
