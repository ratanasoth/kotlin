...
fun main(args : Array<String>) {
    ...
    x<!NI;UNSAFE_CALL!><!UNSAFE_CALL!>.<!><!>foo(<!NI;TYPE_MISMATCH!><!TYPE_MISMATCH!>y<!><!>)
    x!!.foo(<!NI;TYPE_MISMATCH!><!TYPE_MISMATCH!>y<!><!>)
    x.foo(y!!)
    ...
    a<!NI;UNSAFE_CALL!><!UNSAFE_CALL!>.<!><!>foo(b<!NI;UNSAFE_CALL!><!UNSAFE_CALL!>.<!><!>foo(<!NI;TYPE_MISMATCH!><!TYPE_MISMATCH!>c<!><!>))
    a!!.foo(b<!NI;UNSAFE_CALL!><!UNSAFE_CALL!>.<!><!>foo(<!NI;TYPE_MISMATCH!><!TYPE_MISMATCH!>c<!><!>))
    a.foo(b!!.foo(<!NI;TYPE_MISMATCH!><!TYPE_MISMATCH!>c<!><!>))
    a<!NI;UNNECESSARY_NOT_NULL_ASSERTION!><!UNNECESSARY_NOT_NULL_ASSERTION!>!!<!><!>.foo(b<!NI;UNNECESSARY_NOT_NULL_ASSERTION!><!UNNECESSARY_NOT_NULL_ASSERTION!>!!<!><!>.foo(<!NI;TYPE_MISMATCH!><!TYPE_MISMATCH!>c<!><!>))
    a.foo(b.foo(c!!))
