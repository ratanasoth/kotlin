...
class Outer {
    ...
    companion object {
        ...
        fun baz() {
            ...
            Inner(<!NI;CONSTANT_EXPECTED_TYPE_MISMATCH!><!CONSTANT_EXPECTED_TYPE_MISMATCH!>1<!><!>)
            Inner("")
        }
    }
}
...
fun foo() {
    ...
    Outer.Inner(<!NI;CONSTANT_EXPECTED_TYPE_MISMATCH!><!CONSTANT_EXPECTED_TYPE_MISMATCH!>1<!><!>)
    Outer.Inner("")
}
