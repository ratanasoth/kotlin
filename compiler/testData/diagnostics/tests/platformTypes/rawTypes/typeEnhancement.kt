...
fun main() {
    ...
    Test.rawField.foo(<!NI;NULL_FOR_NONNULL_TYPE!><!NULL_FOR_NONNULL_TYPE!>null<!><!>, doubleList)
    Test.DerivedRawA().foo(<!NI;NULL_FOR_NONNULL_TYPE!><!NULL_FOR_NONNULL_TYPE!>null<!><!>, doubleList)
}
