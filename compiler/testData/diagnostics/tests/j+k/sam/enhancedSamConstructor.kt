...
// FILE: main.kt
fun main() {
    J <!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>{ <!EXPECTED_PARAMETER_TYPE_MISMATCH!>s: String<!> -> s}<!><!> // should be prohibited, because SAM value parameter has nullable type
    ...
    J2 <!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>{ <!EXPECTED_PARAMETER_TYPE_MISMATCH!>s: String<!> -> s}<!><!>
