...
@SinceKotlin("1.2")
@InlineOnly
public inline fun Double.pow(a: Double): Double = nativeMath.pow(this, a)
...
@SinceKotlin("1.2")
@InlineOnly
public inline fun Float.pow(a: Float): Float = nativeMath.pow(this.toDouble(), a.toDouble()).toFloat()
